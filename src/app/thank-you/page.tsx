...
export default async function ThankYouPage({
  ...
  const { registration_id: registrationId, session_id: sessionId } = await searchParams;
    ...
    <section className="py-24 sm:py-28">
      <Container>
        <div className="mx-auto max-w-3xl rounded-[2rem] border border-white/90 bg-white px-8 py-14 text-center shadow-[0_25px_70px_rgba(15,23,42,0.06)] sm:px-12">
          <p className="text-sm font-semibold uppercase tracking-[0.28em] text-rose-500">Registration Received</p>
          <h1 className="mt-4 text-4xl font-semibold text-slate-900">
            {paymentConfirmed ? "Your registration is confirmed." : "We received your checkout."}
          </h1>
